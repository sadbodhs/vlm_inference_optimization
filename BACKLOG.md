...
| 16 | R1b: crops chosen without labels (tracker proximity groups), negatives from gate-fired windows, crop + context as lead arm | R1: oracle boxes leak participants; crops name an activity for 86–100% of uninvolved people | the single-person +12–16 point gain survives label-free crops; crop + context keeps false alarms near the full frame's | ~0.5 GPU day | B · R1b | idea |
